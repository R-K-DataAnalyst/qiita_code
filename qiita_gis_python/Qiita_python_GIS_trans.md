...
![image-47.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/542929/c80fed41-c670-c4fc-7945-5e2057cd532a.png)
<br>

ベクターデータに変換できたら、モラン$I$統計量などを求められる。
...
plt.show()
```
![image-42.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/542929/d9b390ae-45e6-0cd0-73af-4b30982ba982.png)
...
```
![image-48.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/542929/0801ee78-962a-b446-222d-5c2f021104e4.png)
<br>
...
![image-49.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/542929/65761e87-4156-8519-cee9-6179f6d3abbb.png)
<br>
...
![image-50.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/542929/8f7fea5d-e601-ca09-6624-465bec1ba41e.png)
<br>
...
![image-51.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/542929/a377d642-41dc-d292-3fd5-47cef40cd6d3.png)  
<br> 
...
Googleマップ：
![image-54.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/542929/c69eeb5a-bb28-668d-3ab3-71963ec5c18e.png)  
<br>

4の地域はすぐ南の地域まで住宅街があるが、この地域から森林がある地域になる。  
Googleマップ：
![image-55.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/542929/ee05e975-3c75-3e7b-5bd3-522a3a2337b9.png)  
<br>

このように、空間的な相関から、周囲と違う地域を見つけることもできる。  
...
plt.show()
```
![image-52.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/542929/1d305ac3-c810-cf8b-a91b-c111793d8aad.png)  
<br>
...
![image-53.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/542929/492420d8-60df-7a65-68d1-82d7138c6621.png)
...
ラスタデータを扱うにはベクターデータも扱えないといけないので、今回のような課題を設定して試しに分析してみると、データハンドリングのスキルがかなり身につくような気がする。単純な本の写経ではなくてあくまで独自のテーマを本を参考にしながら進めるのが良いと思う。  
今後は機械学習を使った空間予測とかそのあたりの勉強をしようかな。  
[「Pythonで学ぶ衛星データ解析基礎 環境変化を定量的に把握しよう」](https://gihyo.jp/book/2022/978-4-297-13232-3)は本当に神本だった。  
